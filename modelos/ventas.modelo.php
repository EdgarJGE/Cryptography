...
class ModeloVentas{
	...
	static public function mdlIngresarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_paciente, id_vendedor, servicios, total, metodo_pago) VALUES (:codigo, :id_paciente, :id_vendedor, :servicios, :total, :metodo_pago)");
	...
	static public function mdlEditarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  id_paciente = :id_paciente, id_vendedor = :id_vendedor, servicios = :servicios, total= :total, metodo_pago = :metodo_pago WHERE codigo = :codigo");
