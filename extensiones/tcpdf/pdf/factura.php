...
$servicios = json_decode(Cifrar::decrypt($respuestaVenta["servicios"]), true);
$total = number_format($respuestaVenta["total"],2);

//TRAEMOS LA INFORMACIÓN DEL PACIENTE

$itemPaciente = "idpaciente";
$valorPaciente = $respuestaVenta["id_paciente"];

$respuestaPaciente = ControladorPacientes::ctrMostrarPacientes($itemPaciente, $valorPaciente);

$nombre = Cifrar::decrypt($respuestaPaciente[0]["nombre"]);
...
$nombreVendedor = Cifrar::decrypt($respuestaVendedor["nombre"]);
...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/logo-bloque.png"></td>
...
$itemServicio = "descripcion";
$valorServicio = $item["descripcion"];

$respuestaServicio = ControladorServicios::ctrMostrarServicios($itemServicio, $valorServicio);

$valorUnitario = number_format($respuestaServicio["precio"], 2);
